...
fn test_sid_data_vch_jada() {
    ...
    let sd = SidData::Voucher(BTreeSet::from([
        ...
        Sid::VchSerialNumber(Yang::String(Attr::SerialNumber(b"JADA123456789".to_vec()))),
    ]));
    println!("sd: {:?}", sd);
